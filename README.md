...
1. Create an account on [Resend](https://resend.com) and verify your sending domain. (NOTE: custom domain is needed for reliable work - otherwise the limit is 2 emails / day. If unsure about your own domain, you can configure a subdomain, treated separately for SPF/DMARC/etc. without hurting your main domain's reputation.)
